// vals — Val's birthday edition. Same engine + art + gametext as the base game; adds the two
// SHARED celebration scenes. All their text lives in this variant's gametext.txt
// (variants/vals/gametext.txt). Val keeps the decorative dino via `celebrationShowDino = true`.
// Drop Val's 3 hero sprites into variants/vals/custom-art/ to override art.
